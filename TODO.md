...
- [x] [FEAT] Implement deposit functionality for all four ESO Currencies.
...
| **`[UI]`** | Interface | Updating the visual styling and appeal of the project. |
| **`[UX]`** | Experience | Improving navigation, vibe, or visual comprehension. |
| **`[DATA]`** | Metadata | Updates to data pipelines and storage. |
| **`[TEST]`** | Validation | Automated tests, scripts and validation logic. |
